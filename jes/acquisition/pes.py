...
The computation follows the procedure described in the supplementary material for
E.Garrido-Merchan and D. Hernandez-Lobato paper: "Predictive Entropy Search for
...
def _compute_log_determinant(
    ...
    """
    log_det_cov = logdet(cov[..., 0:q, 0:q])
